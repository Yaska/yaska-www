...
exports.fourOhFour = function (doc, req) {
    return {
        title: '404 - Not Found',
		pageID: 'fourOhfour',
		fullYear: fullYear,
...
exports.index = function(doc, req){
	return{
		title: 'Yaska - Apple Consultants Network',
		fullYear: fullYear,
		pageID: 'index',
...
exports.contact = function(doc, req){
	return{
		...
		nav_contact: 'active',
		pageID: 'contact',
		extraScripts: ['<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAdoNt2UX3HTe5LXZLr8YF5sS14vtr7Bjw&sensor=true"></script>', '<script src="/static/scripts/maps.js"></script>'],
...
exports.projects = function(doc, req){
	return{
		title: 'projects',
		fullYear: fullYear,
		content: templates.render('projects.html', req, {})
	};
}
...
exports.post = function(doc, req){
	if(req.userCtx.roles.indexOf("y_editor") === -1){
		return{
			title: 'unauthorised',
			fullYear: fullYear,
			content: '<p>You must be an editor to talk the talk and post the post.<br />Please <a href="/login">log in</a> now.</p>'
		}
	}
...
exports.new_post = function(doc, req){
	if(req.userCtx.roles.indexOf("y_editor") === -1){
				return{
					title: 'unauthorised',
					fullYear: fullYear,
					content: '<p>You must be an editor to post.<br />Please <a href="/login">log in</a> now.</p>'
				}
			}
	else{
