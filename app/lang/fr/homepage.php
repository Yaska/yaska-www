...
return array(
  ...
  'herosubtitle' => 'Encore plus pour votre business.',
  'herointro' => 'Bonjour, nous sommes Yaska.',
  'herotext' => 'Nous croyons que les technologies Mac peuvent améliorer votre business de la même façon qu’elles ont révolutionné notre quotidien.',
  'herobutton' => 'Découvrez comment',
  ...
  'servicecodingtext' => 'Optimisez votre business avec nos solutions et nos workflows automatisés.',

  'servicesupportintro' => '… pour vous procurer une tranquillité d’esprit.',
  'servicesupporttitle' => 'Yaska Support',
  'servicesupporttext' => 'Bénéficiez de l’assistance technique et de la maintenance de votre infrastructure IT pour',
  'servicesupportbold' => '49 €/mois.',

  'servicehostingintro' => '… pour protéger ce qui compte.',
  'servicehostingtitle' => 'Yaska Hosting',
  'servicehostingtext' => 'Hébergez vos datas en toute sécurité sur nos Mac Mini pour',
  ...
  'positionceo' => 'Gérant',
  'positioncfo' => 'Administration et Compta',
  'positionconsultancy' => 'Apple Certified Technical Coordinator (ACTC)',
  'positionpoland' => 'Directrice Pologne et Gestion de Projets',
  'positionsales' => 'Commerciale',
  'positiongraphic' => 'Design et Interfaces',
  'positiondev' => 'Développeur Web',
  'positionbackend' => 'Développeur “Back-end”',
  'positionyou' => 'Vous êtes un Mac environmentalist ?',
  'positionjoin' => 'Join us!',

  'flavourarthur' => 'Il a plus d’iPhones que de chaussettes.',
  'flavouralexis' => 'La marque à la pomme oui, mais sans pépins.',
  'flavoureric' => 'Il fait ses tableaux Excell dans Numbers.',
  'flavourdavid' => '1984 est son chiffre fétiche.',
  'flavourjulien' => 'Il a lu 27 x la bio officielle de Steve Jobs.',
  'flavourmonika' => 'Elle vit, dort et mange Mac.',
  'flavourkarl' => 'Chaque soir, c’est lui qui ferme l’App Store.',
  'flavourlaura' => 'Son rêve : organiser une Keynote Apple.',
  'flavourpierre' => 'Il a souvent la tête dans iCloud.',
